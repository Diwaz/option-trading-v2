...
export class RedisSubscriber {
  ...
  async runLoop() {
    while (1) {
      ...
      console.log("received message from the callback queue", messages[0].message);
      this.callbacks[messages[0].message.id](messages[0].message);
      // this.callback { id : resove(data)}
